    ...
    <div className="p-4 md:p-6 space-y-4 md:space-y-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <Button size="sm" variant={period === 'weekly' ? 'primary' : 'secondary'} className="px-4 py-2 rounded-lg text-sm" onClick={() => setPeriod('weekly')}>Weekly</Button>
          <Button size="sm" variant={period === 'monthly' ? 'primary' : 'secondary'} className="px-4 py-2 rounded-lg text-sm" onClick={() => setPeriod('monthly')}>Monthly</Button>
        </div>
      </div>
